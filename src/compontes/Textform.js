...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="con" style={{color:props.mode==='dark'?'white':'black'}}> 
            ...
            <button className="btn btn-primary my-3 mx-3" onClick={ handleSpace }> Remove Extra Space</button>
        </div>

        <div className="dds my-2" style={{color:props.mode==='dark'?'white':'black'}}>
        <h2>Your text summary</h2>
        <p>{text.split(" ").length} words and {text.length} characters</p>
        <p>{.008*text.split(" ").length} Minutes to read this text</p>
        <h2>Preview Text</h2>
